...
class MadryGenerator:
    ...
    def generateMadryModel(self, training_dataset, validation_dataset, eps, eps_iter, nb_iter, alpha=0.5, epochs=100, name="madry"):
        ...
        def train_step(x, y):
            with tf.GradientTape() as tape:
                ...
                x_adv = projected_gradient_descent(model, x, eps=eps, eps_iter=eps_iter, nb_iter=nb_iter, norm=np.inf, clip_min=0, clip_max=255)
        ...
        trained_epochs = 0
        epochs_time = []
        path = "trained_models/defenses/madry/"+name+".h5" # where to save the model
